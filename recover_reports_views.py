...
BAK_FILE = os.path.join(BASE_DIR, 'reports', 'views.py.bak')
...
FILE_MAPPING = {
    'excel_exports.py': ['identified_summary_excel', 'public_form_excel', 'private_anonymous_excel'],
    'pdf_exports.py': ['identified_detailed_pdf', 'public_detailed_pdf', 'private_anonymous_pdf']
}
